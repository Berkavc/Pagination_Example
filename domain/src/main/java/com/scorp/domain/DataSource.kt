package com.scorp.domain
import android.os.Handler
import android.os.Looper
import com.scorp.domain.DataSource.Constants.idRange
...
//        }
        ...
        for (index in 0 until peopleCount) {
            val person = Person(id = RandomUtils.generateRandomInt(range = idRange)  , fullName = PeopleGen.generateRandomFullName())
